...
debug=0;
do_plots=0;
distances=0.01:0.01:1.0;
%5distances=[0.1 0.25 0.5 0.75 1.0];
...
for distance_index=1:total_distances
    ...
    for vergence_index=1:total_vergences
        ...
        s=sprintf('iteration %d of %d (%f percent)', iteration, total_iterations,double(iteration/total_iterations)*100.0)
        disp(s)
        %% Create 3D world
        Zw=distances(distance_index);
        vergence=optimal_vergences(distance_index);
        ...
        [image_left_rectified,...
            ...
            cameraMatrix2Rectified]=rectify_stereo(foveal,...
            l_image,...
            r_image,...
            transf_r_to_l(1:3,1:3)'...
            ,transf_r_to_l(1:3,4)');
        ...
        [covariance_matrices, information_matrices, information_norms, mean_3d, real_3d,...
            mean_sigma_points,...
            mean_sigma_points_rectified_1,...
            mean_sigma_points_rectified_2] =get_uncertainty(foveal,transform',disparities_rectified');
        toc
        ...
        average_information(distance_index,vergence_index)=total_information(distance_index,vergence_index)/(pi*(M/2)^2);
