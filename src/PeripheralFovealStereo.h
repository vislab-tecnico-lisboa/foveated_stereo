#ifndef PERIPHERALFOVEALSTEREO_H
#define PERIPHERALFOVEALSTEREO_H

#include "Stereo.h"
#include "stereo_sensors/PeripheralFoveal.h"

class PeripheralFovealStereo : public Stereo
{

public:
    PeripheralFovealStereo(const cv::Mat & cameraMatrix1_,
    ...
    PeripheralFoveal sensor;
};

#endif // PERIPHERALFOVEALSTEREO_H
