#ifndef STEREOFOVEAL_H
#define STEREOFOVEAL_H

#include "Stereo.h"
#include "stereo_sensors/Periphery.h"

class PeripheralStereo : public Stereo
{

public:
    PeripheralStereo(const cv::Mat & cameraMatrix1_,
